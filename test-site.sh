...
echo ""
echo "2. API products"
code=$(curl -sf -o /dev/null -w "%{http_code}" "$BASE/api/products")
echo "   $BASE/api/products → $code"
...
echo ""
echo "4. Create order (Platinum Executive \$350)"
...
echo ""
echo "7. Deposit verification (Kraken)"
